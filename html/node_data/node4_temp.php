...
<?php
	...
	if(($exist > 0) && ($exists > 0)){
		...
		if ($row['temp'] > $rows['max_temp']){
			echo "
			<script>
				document.getElementById('threshold_temp04').innerHTML= 'Hight' ;
				document.getElementById('temp04').style.backgroundColor = 'red';
				document.getElementById('temp04').style.color = 'white';   
			</script>
				";
		}
		elseif ($row['temp'] < $rows['min_temp']) {
			echo "
			<script>
				document.getElementById('threshold_temp04').innerHTML= 'Low' ;
				document.getElementById('temp04').style.backgroundColor = '#35424a';
				document.getElementById('temp04').style.color = 'white';
			</script>
				";
		}
			...
			echo "
			<script>
				document.getElementById('threshold_temp04').innerHTML= 'Normal' ;
			</script>
				";
		}
	}
