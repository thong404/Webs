...
<?php
	...
	if(($exist > 0) && ($exists > 0)){
		...
		if ($row['temp'] > $rows['max_temp']){
			echo "
			<script>
				document.getElementById('threshold_temp03').innerHTML= 'Hight' ;
				document.getElementById('temp03').style.backgroundColor = 'red';
				document.getElementById('temp03').style.color = 'white';   
			</script>
				";
		}
		elseif ($row['temp'] < $rows['min_temp']) {
			echo "
			<script>
				document.getElementById('threshold_temp03').innerHTML= 'Low' ;
				document.getElementById('temp03').style.backgroundColor = '#35424a';
				document.getElementById('temp03').style.color = 'white';
			</script>
				";
		}
			...
			echo "
			<script>
				document.getElementById('threshold_temp03').innerHTML= 'Normal' ;
			</script>
				";
		}
	}
