...
<body>
	<header>
		<div class="container">
			<nav>
				<ul>
					<li><a href="edit.php"><i class="fa fa-edit"></i></a></li>
					<li><a href="manual.php"><i class="fa fa-wrench"></i></a></li>
			...
			<div class="box">
				...
				<div class="container_boxes_1">
					<div class="temp" id="temp01">
						<h3>TEMPERATURE</h3>
						<h1 id="tempv01">01</h1>
						<p id="threshold_temp01">Threshold</p>
					</div>
					<div class="lux" id="lux01">
						<h3>LUX</h3>
						<h1 id="luxv01">01</h1>
						<p id="threshold_lux01">Threshold</p>
					</div>
					<div class="humidity" id="humi01">
						<h3>HUMIDITY</h3>
						<h1 id="humiv01">01</h1>
						<p id="threshold_humi01">Threshold</p>
					</div>
					<div class="soil_humidity" id="shumi01">
						<h3>SOIL HUMIDITY</h3>
						<h1 id="shumiv01">01</h1>
						<p id="threshold_shumi01">Threshold</p>
					</div>
				</div>
			</div>
			<div class="box">
			...
			<div class="box">
				...
				<div class="container_boxes_1">
					<div class="temp" id="temp03">
						<h3>TEMPERATURE</h3>
						<h1 id="tempv03">01</h1>
						<p id="threshold_temp03">Threshold</p>
					</div>
					<div class="lux" id="lux03">
						<h3>LUX</h3>
						<h1 id="luxv03">01</h1>
						<p id="threshold_lux03">Threshold</p>
					</div>
					<div class="humidity" id="humi03">
						<h3>HUMIDITY</h3>
						<h1 id="humiv03">01</h1>
						<p id="threshold_humi03">Threshold</p>
					</div>
					<div class="soil_humidity" id="shumi03">
						<h3>SOIL HUMIDITY</h3>
						<h1 id="shumiv03">01</h1>
						<p id="threshold_shumi03">Threshold</p>
					</div>
				</div>
			</div>
			<div class="box">
